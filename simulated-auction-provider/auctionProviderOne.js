...
window.auctionProviderOne.cmd = window.auctionProviderOne.cmd || [];
(function(api, enc) {
  'use strict';
  ...
  api.enableServices = function() {
    ...
    var src = '/simulated-auction-provider/enable-' + queryParams;
    // load async
...
})(window.auctionProviderOne, function (s) { return s; });
